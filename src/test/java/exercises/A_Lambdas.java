...
public class A_Lambdas {
    ...
    public void b_function1() {
        Function<String, String> func = f -> "(" + f + ")";
    ...
    public void c_consumer1() {
        Consumer<StringBuilder> cons = f -> f.append("abc");
    ...
    public void c_consumer2() {
        Consumer<List<String>> cons = c -> c.clear();
    ...
    public void e_bifunction2() {
        BiFunction<String, String, Integer> bifunc = (x, y) -> x.lastIndexOf(y);
    ...
    public void e_bifunction3() {
        BiFunction<String, String, Integer> bifunc = String::lastIndexOf;
    ...
    public void g_boundMethodRef1() {
        String s = "abcdefghij";
        Function<String, Integer> func = x -> s.indexOf(x);
    ...
    public void g_boundMethodRef2() {
        ...
        String s = "abcdefghij";
        Function<String, Integer> func = s::indexOf;

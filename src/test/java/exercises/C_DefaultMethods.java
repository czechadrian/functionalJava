...
//        or
    ...
    public void c11_computeWithMissingEntries() {
        ...
        keys.forEach(s -> map.compute(s, (x1, x2) -> x2 == null ? x1 : x2.toUpperCase()));
    ...
    public void c12_computeAndRemoveSomeEntries() {
        ...
        keys.forEach(k -> map.compute(k, (s1, s2) -> s2.isEmpty() ? null : s2.toUpperCase()));
